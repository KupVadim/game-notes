...
Выбирайте архив под вашу операционную систему (обычно `.zip`).
...
- **не увеличивайте громкость голосового пакета**

!!! tip
    Так голос остаётся чётким, без клиппинга и искажений.
